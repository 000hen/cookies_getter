...
CHROME_PATH = os.path.normpath(os.path.join(os.getenv("APPDATA"), "../Local/Google/Chrome/User Data/"))

print(CHROME_PATH)

# Copy Cookies and Local State to current folder
copyfile(os.path.join(CHROME_PATH, "Default/Network/Cookies"), './Cookies')
...
print(list(decrypted_key), len(decrypted_key))
